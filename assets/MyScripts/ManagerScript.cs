...
public class ManagerScript : MonoBehaviour
{
    ...
    // TODO delete this shit, it is not used right now, everything defines itself the values,
    // alternative, define everything here, and get it also from here ... lol
    ...
    public static void newTrial ()
    {
        if (ManagerScript.getState() != ManagerScript.states.end)
        {
            ...
            // this shit is not used at all ... i commendted this out, later i shall delete this
            // TODO delete this shit
...
//                speed = trialList [realTrialNumber].speed;
            // spawndistance is not used , other than for recording data  where it was wrong ... ...
