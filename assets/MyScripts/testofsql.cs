...
//                  t.Start();
    ...
    public void CreateStressor (string success)
    {
        ...
        if (success == "defeated")
        {
            ...
            //  INSERT INTO `Stressors`(`Stressors_id`,`SpawnTime`,`StartDefeatTime`,`TillWhenDefeatable`,`DefeatedAtTime`,`Defeated`,`RotationSpeed`,`ButtonToEarlyPushed`,`Type`,`DefeatableTimeWindow`,`ReactionTime`,`Trial_id`,`ExplosionTime`) VALUES (NULL,'',NULL,NULL,NULL,'',NULL,NULL,'',NULL,NULL,0,NULL);
